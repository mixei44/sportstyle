...
from user.utils import send_email_for_verify
    ...
    def form_invalid(self, form):
        ...
        if form.errors.get('__all__'):
            ...
            if code_n in (401, 429):  # For users with unconfirmed mail
                return JsonResponse(data={'errors': form.errors['__all__'].data[0].message, 'status': code_n, 'text': "Попробуйте еще раз через: "})
